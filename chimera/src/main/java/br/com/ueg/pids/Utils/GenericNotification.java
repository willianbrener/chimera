...
public class GenericNotification {
	...
	public void mensagemSucesso(String mensagem){
		Clients.showNotification(mensagem, "info", null, "middle_center", 3000);
	}

	public void mensagemAviso(String mensagem){
	
		Clients.showNotification(mensagem, "warning", null, "middle_center", 3000);
	}
	...
	public void mensagemError(String mensagem){
		Clients.showNotification(mensagem, "error", null, "middle_center", 1000);
	}
